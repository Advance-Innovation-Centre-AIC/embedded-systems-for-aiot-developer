...
hw_green = find_led("GREEN", 1)   # Dev Kit: RGB_GREEN / Eva: led(1) = เขียว
hw_blue = find_led("BLUE", 2)     # Dev Kit: RGB_BLUE  / Eva: led(2) = น้ำเงิน
...
sld = ui.Slider(x=CX - 100, y=282, w=200, h=16, min=0, max=255, value=150)
