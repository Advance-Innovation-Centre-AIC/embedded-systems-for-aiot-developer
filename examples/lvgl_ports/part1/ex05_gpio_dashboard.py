...
hw_red = find_led("RED", 0)
hw_green = find_led("GREEN", 1)
...
for i in range(4):
    ...
    sw = ui.Switch(x=x + 110, y=y + 5, w=60, h=30)
    leds.append(led)
    sw_ids.append(sw.id())

b_on = ui.Button("All ON", x=40, y=308, w=110, h=48, color=GREEN, value=14)
b_off = ui.Button("All OFF", x=W - 40 - 110, y=308, w=110, h=48, color=RED,
                  value=14)
