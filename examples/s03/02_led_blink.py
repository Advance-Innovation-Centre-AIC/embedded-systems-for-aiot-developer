...
#
# Why : งานปลายคาบคือไฟวิ่งสามดวงที่ปรับจังหวะได้ ทุกอย่างเริ่มจากไฟดวงเดียว
...
#
# ดูที่จอ: หลอดดวงแรกบนบอร์ดกะพริบทุก 250 ms ป้ายบนจอเขียนว่า ติด หรือ ดับ
...
LED = 0                 # ใช้ดวงแรก คือดวงที่ board_info() คืนชื่อมาเป็นตัวแรก
