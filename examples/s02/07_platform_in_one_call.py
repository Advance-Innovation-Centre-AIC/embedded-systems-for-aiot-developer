...
#
# อ่านนอกเวลา ไม่ใช่งานในคาบ 2 และวันนี้ไฟล์นี้ต่อ broker ของห้องไม่ได้ ตั้งใจบอกไว้ก่อน
...
# ส่วน broker.hivemq.com ของคาบนี้รับบอร์ดที่พอร์ต 1883 แบบไม่เข้ารหัส สองทางนี้ไม่เจอกัน
# ครึ่งแรกของไฟล์ (อ่านคลังค่าตั้ง) รันได้วันนี้โดยไม่ต้องมีเน็ต ครึ่งหลังรอคาบ 10 กับ 11
