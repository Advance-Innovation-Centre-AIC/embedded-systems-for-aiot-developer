# s08_dashboard.py - Mini-HMI แดชบอร์ด 4 การ์ด บน Eva Kit (ฉบับฝึกเติมโค้ด)
...
#
# แดชบอร์ดใบนี้เอาของหลายอย่างมาไว้หน้าเดียว ถ้าจะแกะทีละชิ้น ตัวอย่างของคาบนี้แยกไว้ให้แล้ว
# การ์ดเข็มทิศยืมแกนกลางมาจาก examples/s08/06_compass_readout.py คือ compass.value()
...
try:
    ...
    #   examples/s08/06_compass_readout.py จัดการด้วยการขึ้นป้ายบอกตรง ๆ ว่ากำลังรอ CM55
...
try:
    while True:
        ...
        if running:
            ...
            # เข็มสั่นทั้งที่วางบอร์ดนิ่ง: examples/s08/06_compass_readout.py วาดทิศตามเวลาไว้ด้วย
